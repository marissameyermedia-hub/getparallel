      ...
      <div className="bg-gray-50 border border-gray-200 rounded-2xl p-4 text-center">
        ...
        <div className="flex items-center justify-center gap-8">
          ...
          <a
            ...
            className="flex flex-col items-center gap-1 text-gray-400 hover:text-parallel-purple transition-colors"
          >
          ...
          >
            ...
            <span className="text-[10px] font-medium">@parallelvip</span>
          </a>
        ...
        /* ── No matches — waiting (never had any) ─────────────── */
          ...
          <div className="max-w-md mx-auto px-4 pt-4 pb-nav">
            <div className="flex flex-col items-center text-center mb-8">
              ...
              <h2 className="text-3xl font-bold mb-2">We're building your city now.</h2>
              <p className="text-parallel-purple font-medium mb-5">We'll notify you the moment it opens.</p>
