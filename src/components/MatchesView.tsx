        ...
        /* ── No matches — waiting (never had any) ─────────────── */
          ...
          <div className="max-w-md mx-auto px-4 pt-4 pb-nav">
            <div className="flex flex-col items-center text-center mb-8">
              ...
              <h2 className="text-3xl font-bold mb-2">We're finding your matches now.</h2>
              <p className="text-parallel-purple font-medium mb-5">We'll notify you when they're ready.</p>
